 ...
 *
 * Compile with: gcc -o tcpserver-nonexecstack tcpserver-nonexecstack-fixed.c -fno-stack-protector
 *
 * Security features:
...
void print_rop_gadgets(void) {
    ...
    printf("    dummy_function1: %p (pop eax/rax; ret)\n", dummy_function1);
    printf("    dummy_function2: %p (pop ebx/rbx; ret)\n", dummy_function2);
    printf("    dummy_function3: %p (pop ecx/rcx; ret)\n", dummy_function3);
